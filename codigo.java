public class Main {
    ...
    public static void main(String[] args) {
        ...
        if(notaCalculada >= 6.0) {
            ...
            System.out.println("Aluno aprovado sem exame final "+notaFinal);
            }
        else{
            if (notaCalculada >= 4.0){
                exf = 8.0;
                notaFinal = exf;
                System.out.println("Aluno aprovado com exame final"+notaFinal);
            }
            else System.out.println("Aluno reprovado"+notaFinal);
        }
    }
